...
</p> </div> <!-- Grid de artículos --> <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto"> <!-- Artículo 1 --> <article class="bg-gray-50 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300"> <div class="h-48 bg-gradient-to-br from-pink-300 to-rose-300 flex items-center justify-center"> <span class="text-white font-bold text-6xl font-poppins">💅
</span></div> <div class="p-6"> <h3 class="text-xl font-semibold text-gray-800 mb-3 font-poppins">
...
</p> <a href="/cuidado-piel" class="text-pink-500 text-sm font-poppins hover:text-pink-700 transition-colors">Leer artículo →</a> </div> </article> <!-- Artículo 2 --> <article class="bg-gray-50 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300"> <div class="h-48 bg-gradient-to-br from-purple-300 to-indigo-300 flex items-center justify-center"> <span class="text-white font-bold text-6xl font-poppins">🌿</span> </div> <div class="p-6"> <h3 class="text-xl font-semibold text-gray-800 mb-3 font-poppins">
Cuidado de la Piel
</h3> <p class="text-gray-600 mb-4 font-poppins">
